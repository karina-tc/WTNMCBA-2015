...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <div class="pure-menu pure-menu-horizontal contain-menu">
	    ...
	    <ul class="pure-menu-list menu-links">
	        ...
	        <li class="pure-menu-item pure-menu-selected"><a href="../WTNMCBA-2015/events-calendar.php" class="pure-menu-link">Calendar</a></li>
	        ...
	        <li class="pure-menu-item pure-menu-selected"><a href="../WTNMCBA-2015/contact-us.php" class="pure-menu-link">Contact Us</a></li>
	    	<li class="pure-menu-item pure-menu-selected"><a href="../WTNMCBA-2015/member-registration.php" class="pure-menu-link" id="become-member">Become a Member</a></li>
	    </ul>
	</div>
	</nav>
