...
@import "http://www.jotform.com/themes/css/buttons/form-submit-button-light.css";
.form-all {
...
.form-line-error {
  background-color: none;
  -webkit-box-shadow: inset 0px 3px 11px -7px #e15353;
  -moz-box-shadow: inset 0px 3px 11px -7px #e15353;
  box-shadow: inset 0px 3px 11px -7px #e15353;
}
...
.form-textbox:focus, .form-textarea:focus, .form-radio-other-input:focus, .form-checkbox-other-input, .form-captcha input, .form-spinner input:focus, input:active {
    background-color : #edf5fc;
    outline : 0;
    border : 2px solid #72aade !important;
...
<form style="margin-top:-100px" class="jotform-form" action="https://submit.jotform.us/submit/50681142397154/" method="post" enctype="multipart/form-data" name="form_50681142397154" id="50681142397154" accept-charset="utf-8">
    ...
    <ul class="form-section page-section">
      ...
      <li class="form-line jf-required" data-type="control_paypalpro" id="id_7">
        ...
        <div id="cid_7" class="form-input-wide jf-required">
          <input type="hidden" name="simple_fpc" data-payment_type="paypalpro" value="7" />
          <span class="form-product-item hover-product-item">
            <input class="form-radio validate[required]" type="radio" id="input_7_1001" name="q7_subscriptionDetails[][id]" value="1001" checked="checked" />
            <label for="input_7_1001">
              Member Yearly Subscription
          ...
          <table summary="" class="form-address-table" border="0" cellpadding="4" cellspacing="0">
            ...
            <tr>
              <td valign="top" style="min-width:50px;" rowspan="2">
                <input type="radio" class="paymentTypeRadios" id="input_7_paymentType_credit" name="q7_subscriptionDetails[paymentType]" value="credit">
                <label for="input_7_paymentType_credit">
                  <div style="display:inline-block; padding-right: 4px;">
                    <img align="absmiddle" src="https://d2g9qbzl5h49rh.cloudfront.net/images/blank.gif" class="paypalpro_img paypalpro_visa" style="display: inline-block" />
                    <img align="absmiddle" src="https://d2g9qbzl5h49rh.cloudfront.net/images/blank.gif" class="paypalpro_img paypalpro_mc" style="display: inline-block" />
                    <img align="absmiddle" src="https://d2g9qbzl5h49rh.cloudfront.net/images/blank.gif" class="paypalpro_img paypalpro_amex" style="display: inline-block" />
                    <img align="absmiddle" src="https://d2g9qbzl5h49rh.cloudfront.net/images/blank.gif" class="paypalpro_img paypalpro_dc" style="display: inline-block" />
                  </div>
                </label>
              </td>
              <td align="left" valign="top" style="padding-bottom: 2px !important;">
                <input type="radio" class="paymentTypeRadios" id="input_7_paymentType_express" name="q7_subscriptionDetails[paymentType]" checked="checked" value="express">
                <label for="input_7_paymentType_express"> <img align="absmiddle" src="https://www.paypalobjects.com/webstatic/en_US/i/buttons/pp-acceptance-small.png"> </label>
              </td>
            </tr>
            <tr>
              <td valign="top">
                <a style="font-size:9px;" target="_blank" href="https://www.paypal.com/webapps/mpp/paypal-popup">What is PayPal?</a>
              </td>
            </tr>
          </table>
          <table summary="" style="display:none" id="creditCardTable" class="form-address-table" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td width="50%">
                <span class="form-sub-label-container" style="vertical-align: top">
                  <input class="form-textbox validate[required] cc_firstName" type="text" name="q7_subscriptionDetails[cc_firstName]" id="input_7_cc_firstName" size="20" />
                  <label class="form-sub-label" for="input_7_cc_firstName" id="sublabel_cc_firstName" style="min-height: 13px;"> First Name </label>
                </span>
              </td>
              <td width="50%">
                <span class="form-sub-label-container" style="vertical-align: top">
                  <input class="form-textbox validate[required] cc_lastName" type="text" name="q7_subscriptionDetails[cc_lastName]" id="input_7_cc_lastName" size="20" />
                  <label class="form-sub-label" for="input_7_cc_lastName" id="sublabel_cc_lastName" style="min-height: 13px;"> Last Name </label>
                </span>
              </td>
            </tr>
            <td colspan="2">
              <span class="form-sub-label-container" style="vertical-align: top">
                <input class="form-textbox validate[required] cc_number" type="tel" name="q7_subscriptionDetails[cc_number]" id="input_7_cc_number" size="20" autocomplete="off" />
                -
                <label class="form-sub-label" for="input_7_cc_number" id="sublabel_cc_number" style="min-height: 13px;"> Credit Card Number </label>
              </span>
              <span class="form-sub-label-container" style="vertical-align: top">
                <input class="form-textbox validate[required] cc_ccv" type="tel" name="q7_subscriptionDetails[cc_ccv]" id="input_7_cc_ccv" style="width:52px" autocomplete="off" />
                <label class="form-sub-label" for="input_7_cc_ccv" id="sublabel_cc_ccv" style="min-height: 13px;"> Security Code </label>
              </span>
            </td>
            </tr>
            <tr>
              <td colspan="2">
                <span class="form-sub-label-container" style="vertical-align: top">
                  <select class="form-dropdown validate[required] cc_exp_month" name="q7_subscriptionDetails[cc_exp_month]" id="input_7_cc_exp_month">
                    <option>  </option>
                  ...
                  /
                  <label class="form-sub-label" for="input_7_cc_exp_month" id="sublabel_cc_exp_month" style="min-height: 13px;"> Expiration Month </label>
                </span>
                <span class="form-sub-label-container" style="vertical-align: top">
                  <select class="form-dropdown validate[required] cc_exp_year" name="q7_subscriptionDetails[cc_exp_year]" id="input_7_cc_exp_year">
                    <option>  </option>
                  ...
                  <label class="form-sub-label" for="input_7_cc_exp_year" id="sublabel_cc_exp_year" style="min-height: 13px;"> Expiration Year </label>
                </span>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td colspan="2">
                <span class="form-sub-label-container" style="vertical-align: top">
                  <input class="form-textbox validate[required] form-address-line" type="text" name="q7_subscriptionDetails[addr_line1]" id="input_7_addr_line1" />
            ...
            <tr>
              <td colspan="2">
                <span class="form-sub-label-container" style="vertical-align: top">
                  <input class="form-textbox form-address-line" type="text" name="q7_subscriptionDetails[addr_line2]" id="input_7_addr_line2" size="46" />
            ...
            <tr>
              <td width="50%">
                <span class="form-sub-label-container" style="vertical-align: top">
                  <input class="form-textbox validate[required] form-address-city" type="text" name="q7_subscriptionDetails[city]" id="input_7_city" size="21" />
                  <label class="form-sub-label" for="input_7_city" id="sublabel_7_city" style="min-height: 13px;"> City </label>
                </span>
              </td>
              <td>
                <span class="form-sub-label-container" style="vertical-align: top">
                  <input class="form-textbox validate[required] form-address-state" type="text" name="q7_subscriptionDetails[state]" id="input_7_state" size="22" />
            ...
            <tr>
              <td width="50%" function zip(){var iterator=Prototype.K,args=$A(arguments);if(Object.isFunction(args.last())) iterator=args.pop();var collections=[this].concat(args).map($A);return this.map(function(value,index){return iterator(collections.pluck(index));});}>
                <span class="form-sub-label-container" style="vertical-align: top">
                  <input class="form-textbox validate[required] form-address-postal" type="text" name="q7_subscriptionDetails[postal]" id="input_7_postal" size="10" />
                  <label class="form-sub-label" for="input_7_postal" id="sublabel_7_postal" style="min-height: 13px;"> Postal / Zip Code </label>
                </span>
              </td>
              <td>
                <span class="form-sub-label-container" style="vertical-align: top">
                  <select class="form-dropdown validate[required] form-address-country" name="q7_subscriptionDetails[country]" id="input_7_country">
                    <option value="" selected> Please Select </option>
                    <option value="United States"> United States </option>
                    <option value="Afghanistan"> Afghanistan </option>
                    <option value="Albania"> Albania </option>
  ...
  <input type="hidden" id="simple_spc" name="simple_spc" value="50681142397154" />
  <script type="text/javascript">
  document.getElementById("si" + "mple" + "_spc").value = "50681142397154-50681142397154";
  </script>
</form>